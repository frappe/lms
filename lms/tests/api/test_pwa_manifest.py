...
class TestPWAManifest(BaseTestUtils):
	...
	def test_manifest_shape(self):
		...
		def maskable_separated_from_any():
		...
		cases = [
			...
			("scope_and_id_track_the_lms_route", scope_and_id_track_the_lms_route),
			("colours_for_the_os_chrome", colours_for_the_os_chrome),
			("both_icon_sizes", both_icon_sizes),
			("maskable_separated_from_any", maskable_separated_from_any),
		]
