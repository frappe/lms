			...
			<div class="flex min-w-0 flex-col gap-1">
				...
				>
					<Button
						...
						:label="title"
						class="-ms-3.5 !max-w-96 !justify-start !pe-0 text-p-lg-semibold cursor-pointer hover:bg-transparent hover:opacity-70 focus:bg-transparent active:bg-transparent active:text-ink-gray-5"
						@click="emit('back')"
					/>
