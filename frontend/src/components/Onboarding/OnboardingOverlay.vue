<template>
  <div
    v-if="show"
    class="fixed inset-0 z-[100] flex items-center justify-center bg-white h-screen flex flex-col"
  >
    <!-- Top Bar -->
    <div class="flex items-center justify-between px-8 py-4 w-full border-b h-16">
    ...
    <!-- Content -->
    <div class="h-[calc(100vh-64px)] w-full p-8 flex items-center justify-center overflow-y-auto">
        <div class="w-full max-w-4xl flex flex-col items-center w-full">
