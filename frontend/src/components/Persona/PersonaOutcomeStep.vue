<template>
	<div class="flex flex-col gap-0.5">
		<button
			...
			type="button"
			class="group flex items-center gap-3 rounded-6 px-2 py-2.5 text-start transition-colors hover:bg-surface-gray-2 focus:outline-none focus-visible:bg-surface-gray-2"
